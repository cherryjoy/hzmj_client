...
public class UITextList : MonoBehaviour
{
	...
	protected void Add (string text, bool updateVisible)
	{
		...
		{
			// Rebuild the line
			ce.lines = textLabel.font.WrapText(ce.text, maxWidth / textLabel.transform.localScale.y, true, true, textLabel.FontSize).Split(mSeparator);
	...
	void Awake ()
	{
        ...
        Collider col = this.GetComponent<Collider>() as Collider;
