Shader "LK/Transparent/Tex"
{
	Properties
	{
		...
		_AdditiveAlpha("_AdditiveAlpha",Float) = 0
		[KeywordEnum(None,UV)] _Option("Option",Int) = 0
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature __ _OPTION_UV
