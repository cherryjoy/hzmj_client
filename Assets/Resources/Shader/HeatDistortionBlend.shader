Shader "CM/HeatDistortionBlend" 
{
	Properties 
	{
		...
		_HeatForce ("Heat Force", Range(0.01, 10)) = 0.5
		...
		SubShader 
		{
			...
			Pass 
			{
				...
				half4 frag(v2f i) : COLOR
				{
					...
					i.uvgrab.x += overlayColor.a * (offsetColor1.r + offsetColor2.r - 1) * _HeatForce;
					i.uvgrab.y += overlayColor.a * (offsetColor1.g + offsetColor2.g - 1) * _HeatForce;
					...
					half4 distortedColor = lerp(col_distort, col_orig, 1 - overlayColor.a);
					overlayColor.rgb = overlayColor * _Color.rgb * _Color.a;
					
					half4 finalColor; 
					finalColor.rgb = distortedColor.rgb + overlayColor.rgb * _OverlayPercent ;
					finalColor.a = 1.0;
		...
		SubShader 
		{
			...
			Pass 
			{
				...
				half4 frag(v2f i) : COLOR
				{
					...
					half4 finalColor;
					finalColor.rgb = channelColor.rgb  * _Color.rgb;
					finalColor.a = channelColor.a * _Color.a;
